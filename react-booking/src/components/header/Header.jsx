    ...
    return (
        <div className="header">
            <div className={type ==="list"?"headerContainer listMode":'headerContainer'}>
                ...
                {type!=="list" && <> <h1 className="headerTitle">Lorem ipsum dolor sit amet consectetur adipisicing elit?</h1>
                <p className="headerDesc">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet, libero error facere rerum harum voluptates, earum quaerat consectetur sed, eligendi temporibus hic maiores soluta? Non sit iusto officiis reiciendis quam.</p>
